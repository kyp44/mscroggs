...
\def\advent@xxv@xxi{
  There are ten ways to make a list of four As and Bs that don't contain an \emph{even*} number of consecutive As:
  \begin{multicols}{2}
    \begin{itemize}
      \item B,B,B,B
      \item A,B,B,B
...
\def\advent@xxv@xxii{
  ...
  \grid@advent@xxv@xxii{}{}{}{}{}{}{}{}{}
}

\def\advent@xxv@xxiii{
  $153$ is equal to the sum of the cubes of its digits: $1^3 + 5^3 + 3^3$.

  There are three other three-digit numbers that are equal to the sum of the cubes of their digits.
...
\def\card@xxv@i{
  What is the sum of all the odd integers between $0$ and $12$?
}

\def\card@xxv@ii{
  What is the sum of all the odd integers between $0$ and $44444$?
}

\def\card@xxv@iii{
  Carol has more than one bauble.
...
\def\card@xxv@v{
  What is the smallest three-digit positive integer whose digits are all non-zero and different?
}
...
\def\card@xxv@vii{
  In a Christmas game, you can win either $4$ points or $5$ points on your turn, and the game can last any number of turns.
  What is the largest number of points that it is impossible to end the game on?
}

\def\card@xxv@viii{
  In a different Christmas game, you can win either $495371$ points or $2921695$ points on your turn, and the game can last any number of turns.
  What is the largest number of points that it is impossible to end the game on?
}
...
\def\card@xxv@x{
  What is the smallest four-digit positive integer that can be written as the sum of exactly four consecutive integers?
}

\def\card@xxv@xi{
  Holly drew $18$ points on the circumference of a circle then drew straight lines connecting each pair of points.
  How many straight lines did she draw?
}

\def\card@xxv@xii{
  Holly drew some points on the circumference of a circle then drew straight lines connecting each pair of points.
  She drew $166047976$ straight lines.
  How many points did she draw?
}