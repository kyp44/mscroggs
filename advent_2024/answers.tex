...
\aproblem{14}{625}{\advent@xxiv@xiv}{
  ...
  so that \eqref{eqn:pxiv:dn} holds in the base case.
  Now assume that \eqref{eqn:pxiv:dn} holds for $n$.
...
\aproblem{18}{TODO}{\advent@xxiv@xviii}{
  TODO
}
