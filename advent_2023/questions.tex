...
\newcommand\xxii@dot[2]{\filldraw[black,fill=xxii@purp] (#1, #2) circle (0.15);}
\newcommand\xxii@square[8]{
  ...
  % Dots
  \xxii@dot{#1+\xxii@size*#3}{#2+\xxii@size*#4}
  \xxii@dot{#1+\xxii@size*#5}{#2+\xxii@size*#6}
  \xxii@dot{#1+\xxii@size*#7}{#2+\xxii@size*#8}
}
