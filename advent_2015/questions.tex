...
\def\advent@xv@xxi{
  This year, I posted instructions for making a \href{https://www.mscroggs.co.uk/blog/14}{dodecahedron} and a stellated \href{https://www.mscroggs.co.uk/blog/17}{rhombicuboctahedron}.
...
\def\advent@xv@xxiii{
  ...
  If you treble it and add $16$, the result is also prime.
  Repeating this will give $11$ prime numbers in total (including the number itself).
}
