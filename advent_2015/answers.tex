...
\title{Matthew Scroggs Advent Calendar 2015 Answers}
\author{Dan Whitman}
\date{}
...
\aproblem{23}{587}{\advent@xv@xxiii}{
  This was solved in Python by checking each prime for this property in sequence until the match was found.
}
